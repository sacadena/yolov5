...
def check_file(file, suffix=''):
    ...
    if Path(file).is_file() or not file:  # exists
        ...
        files = []
        for d in 'data', 'yolov5_models', 'yolov5_utils':  # search directories
...
def apply_classifier(x, model, img, im0):
    ...
    # Example model = torchvision.yolov5_models.__dict__['efficientnet_b0'](pretrained=True).to(device).eval()
