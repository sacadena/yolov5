...
from yolov5_utils.dataloaders import LoadImagesAndLabels, img2label_paths
from yolov5_utils.general import LOGGER, check_dataset, check_file
...
class WandbLogger():
    """Log training runs, datasets, yolov5_models, and predictions to Weights & Biases.
    ...
    yolov5_models and predictions can also be logged.
    ...
    def setup_training(self, opt):
        """
        Setup the necessary processes for training YOLO yolov5_models:
