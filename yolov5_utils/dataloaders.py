...
class HUBDatasetStats():
    ...
    Usage1: from yolov5_utils.dataloaders import *; HUBDatasetStats('coco128.yaml', autodownload=True)
    Usage2: from yolov5_utils.dataloaders import *; HUBDatasetStats('path/to/coco128_with_yaml.zip')
    Arguments
