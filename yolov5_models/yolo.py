...
Usage:
    $ python path/to/yolov5_models/yolo.py --cfg yolov5s.yaml
"""
...
class ClassificationModel(BaseModel):
    ...
    def _from_detection_model(self, model, nc=1000, cutoff=10):
        ...
        c.i, c.f, c.type = m.i, m.f, 'yolov5_models.common.Classify'  # index, from, type
...
if __name__ == '__main__':
    ...
    elif opt.test:  # test all yolov5_models
        for cfg in Path(ROOT / 'yolov5_models').rglob('yolo*.yaml'):
            try:
                _ = Model(cfg)
